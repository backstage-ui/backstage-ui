...
export default () => (
  ...
  <div class="bs-ui-action-bar__actions-group">
    <button class="bs-ui-action-bar__action bs-ui-button bs-ui-button--background-black"><i class="material-icons ic ic--left">mode_edit</i>create</button>
  </div>
</div>
    `}/>
  ...
  <div class="bs-ui-action-bar__actions-group">
    <button class="bs-ui-action-bar__action bs-ui-button bs-ui-button--background-black"><i class="material-icons ic ic--left">date_range</i>schedule</button>
    <button class="bs-ui-action-bar__action bs-ui-button bs-ui-button--background-black"><i class="material-icons ic ic--left">cloud_done</i>save</button>
    <button class="bs-ui-action-bar__action bs-ui-button bs-ui-button--background-blue"><i class="material-icons ic ic--left">cloud_upload</i>publish</button>
    <button class="bs-ui-action-bar__action bs-ui-button bs-ui-button--background-black"><i class="material-icons ic">more_horiz</i></button>
  </div>
</div>
    `}/>
