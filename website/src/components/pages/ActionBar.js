    ...
    <div class="bs-ui-action-bar__action bs-ui-collapsed">
      ...
      <div class="bs-ui-options bs-ui-collapsed__options bs-ui-collapsed__options--right">
        <div class="bs-ui-options__list">
          <li class="bs-ui-options__item"><a><i class="material-icons ic bs-ui-options__item__icon">cloud_download</i>Unpublish</a></li>
          <li class="bs-ui-options__item"><a><i class="material-icons ic bs-ui-options__item__icon">history</i>History</a></li>
          <li class="bs-ui-options__item"><a><i class="material-icons ic bs-ui-options__item__icon">delete</i>Delete</a></li>
        </div>
      </div>
    </div>
  </div>
