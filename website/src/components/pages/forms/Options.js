...
`} title="Small" />
  ...
  <div class="bs-ui-options">
    <div class="bs-ui-options__list">
      <li class="bs-ui-options__item">
        <a><i class="material-icons bs-ui-options__icon">delete</i>Delete</a>
      </li>
      <li class="bs-ui-options__item">
        <a><i class="material-icons bs-ui-options__icon">mode_edit</i>Edit</a>
      </li>
      <li class="bs-ui-options__item">
        <a><i class="material-icons bs-ui-options__icon">add_box</i>Add</a>
      </li>
    </div>
  </div>
</div>
